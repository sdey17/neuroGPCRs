...
def main(config_path: str = "config.yaml", protein_feat: str = None, mol_feat: str = None):
    ...
    for seed in seeds:
        ...
        # Train
        save_path = results_dir / f"cosine_seed{seed}.pth"
        ...
        history_df.to_csv(results_dir / f"history_cosine_seed{seed}.csv", index=False)
        ...
        val_df.to_csv(results_dir / f"val_predictions_cosine_seed{seed}.csv")
        ...
        test_unseen_prot_df.to_csv(results_dir / f"test_unseen_protein_cosine_seed{seed}.csv")
        ...
        test_unseen_lig_df.to_csv(results_dir / f"test_unseen_ligand_cosine_seed{seed}.csv")
