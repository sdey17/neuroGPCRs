...
def main(config_path: str = "config.yaml", protein_feat: str = None, mol_feat: str = None):
    ...
    for run_idx, seed in enumerate(seeds, 1):
        ...
        # Train
        save_path = results_dir / f"cosine_run{run_idx}.pth"
        ...
        history_df.to_csv(results_dir / f"history_cosine_run{run_idx}.csv", index=False)
        ...
        val_df.to_csv(results_dir / f"val_predictions_cosine_run{run_idx}.csv")
        ...
        test_unseen_prot_df.to_csv(results_dir / f"test_unseen_protein_cosine_run{run_idx}.csv")
        ...
        test_unseen_lig_df.to_csv(results_dir / f"test_unseen_ligand_cosine_run{run_idx}.csv")
