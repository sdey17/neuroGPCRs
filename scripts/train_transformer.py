...
def main(config_path: str = "config.yaml", protein_feat: str = None, mol_feat: str = None):
    ...
    save_path = results_dir / f"transformer_{config['model']['protein_encoder']}_{config['model']['molecule_encoder']}.pth"
    ...
    history_df.to_csv(results_dir / f"history_transformer.csv", index=False)
    ...
    val_df.to_csv(results_dir / "val_predictions_transformer.csv")
    ...
    test_unseen_prot_df.to_csv(results_dir / "test_unseen_protein_predictions_transformer.csv")
    ...
    test_unseen_lig_df.to_csv(results_dir / "test_unseen_ligand_predictions_transformer.csv")
